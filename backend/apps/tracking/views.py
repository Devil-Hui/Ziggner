...
from .serializers import (
    BrowseHistoryPaginationSerializer,
    BrowseHistorySerializer,
    RecordBrowseSerializer,
)
...
class BrowseHistoryListView(BaseApiView):
    ...
    def get(self, request):
        ...
        pagination = BrowseHistoryPaginationSerializer(data=request.query_params)
        pagination.is_valid(raise_exception=True)
        page = pagination.validated_data['page']
        page_size = pagination.validated_data['page_size']
