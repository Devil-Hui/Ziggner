...
class Messages:
    ...
    COUPON_AUDIENCE_MISMATCH = 'This coupon is not available for your account.'
    ...
    ADMIN_GROUP_EXISTS = 'A group with this name or slug already exists.'
    ADMIN_GROUP_DEFAULT_PROTECTED = 'The default pending group cannot be deleted or renamed.'
    ADMIN_GROUP_SLUG_INVALID = 'Slug may only contain lowercase letters, digits and hyphens, and must start with a letter or digit.'
    ADMIN_GROUP_NAME_INVALID = 'Name must be 1-100 characters.'
    ADMIN_GROUP_SLUG_INVALID_LEN = 'Slug must be 1-100 characters.'
