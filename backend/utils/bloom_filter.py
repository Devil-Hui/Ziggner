...
class BloomFilter:
    ...
    def __init__(
        ...
        self._ready_key = f'{self._redis_key}:ready'
    ...
    def exists(self, value: str) -> bool:
        ...
        try:
            pipe = r.pipeline()
            pipe.get(self._ready_key)
            for offset in self._get_offsets(value):
                pipe.getbit(self._redis_key, offset)
    ...
    def clear(self):
        ...
        r = _get_redis()
        if r:
            r.delete(self._redis_key, self._ready_key)
