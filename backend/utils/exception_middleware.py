...
class CustomExceptionMiddleware:
    ...
    def __call__(self, request):
        ...
        try:
            ...
            # 非 2xx 响应：补全统一错误信封
            return self._wrap_error_response(response, request_id)
            ...
            return self.handle_exception(request, exc, request_id)
    ...
    def handle_exception(self, request, exc, request_id=None):
        ...
        return self._json_response(error_data, status_code=error_data['code'], request_id=request_id)
