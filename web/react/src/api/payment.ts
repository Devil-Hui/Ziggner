...
export type MockPaymentScenario = 'success' | 'failure' | 'cancel' | 'timeout'
...
export const paymentAPI = {
  ...
  completeMock: (paymentNo: string, scenario: MockPaymentScenario) =>
    post<{ status: string; payment_no?: string }>(
      `/payment/mock/${encodeURIComponent(paymentNo)}/complete/`,
      { scenario },
    ),
