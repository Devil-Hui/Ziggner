...
// api/[[path]].js
var BACKEND_URL = typeof env !== "undefined" && env.BACKEND_URL ? env.BACKEND_URL : "https://ziggner-backend.workers.dev";
...
async function onRequest2(context) {
  ...
  if (url.pathname.startsWith("/assets/") || url.pathname.startsWith("/images/") || /\.(js|css|png|jpg|jpeg|gif|svg|ico|woff|woff2|ttf|eot|map)$/.test(
    url.pathname
  )) {
    return next();
  }
...
// ../.wrangler/tmp/pages-eDA7gx/functionsRoutes-0.42183774326300494.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
